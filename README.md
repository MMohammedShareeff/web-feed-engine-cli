...
## Configuration
**create a .gatorconfig file beside your project folder with the below content:**<br>
{<br>
    "db_url": "postgres://postgres:postgres@localhost:5432/gator?sslmode=disable",<br>
    "current_user_name": "titititi"<br>
}
...
npm start register john<br>
npm start login john<br>
npm start addfeed "My Blog" "https://gitlab.com/crossref/schema/-/blob/master/best-practice-examples/dataset.5.3.0.xml"<br>
npm start follow "https://gitlab.com/crossref/schema/-/blob/master/best-practice-examples/dataset.5.3.0.xml"<br>
npm start following
npm start browse 5
npm start agg 30s
